...
/**
 * Wraps {@link RegistrationRequest}, deserialized {@link CollectedClientData} and {@link AttestationObject}.
 *
 * @param clientDataJSON Deserialized {@code registrationRequest.getAuthenticatorParameters().getResponse().getClientDataJSON()}.
 * @param attestationObject Deserialize {@code source.getAuthenticatorParameters().getResponse().getAttestationObject()}.
