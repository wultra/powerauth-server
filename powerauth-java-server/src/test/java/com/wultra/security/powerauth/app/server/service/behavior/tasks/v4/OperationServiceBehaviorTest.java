...
import com.wultra.security.powerauth.client.model.response.v4.OperationListResponse;
...
/**
 * Test for {@link com.wultra.security.powerauth.app.server.service.behavior.tasks.v4.OperationServiceBehavior}.
 *
...
class OperationServiceBehaviorTest {
    ...
    private final com.wultra.security.powerauth.app.server.service.behavior.tasks.v4.OperationServiceBehavior operationService;
    private final com.wultra.security.powerauth.app.server.service.behavior.tasks.v4.OperationTemplateServiceBehavior templateService;
    ...
    void testApproveOperationWithMatchingActivationIdSuccess() throws Exception {
        ...
        operationApproveRequest.setAuthenticationCodeType(AuthenticationCodeType.POSSESSION_KNOWLEDGE);
    ...
    void testApproveOperationWithMatchingActivationIdSuccess_usingOperationTemplateContainingUnsupportedSignatureTypes() throws Exception {
        ...
        final OperationDetailResponse operationDetailResponse = operationService.createOperation(request);
        assertThat(operationDetailResponse.getAuthenticationCodeTypes())
                .hasSize(3)
                .containsExactlyInAnyOrder(AuthenticationCodeType.POSSESSION, AuthenticationCodeType.POSSESSION_KNOWLEDGE, AuthenticationCodeType.POSSESSION_BIOMETRY);
    ...
    void testApproveOperationWithMatchingActivationIdFailed_usingOperationTemplateContainingUnsupportedSignatureTypesOnly() throws Exception {
        ...
        for (AuthenticationCodeType authenticationCodeType : AuthenticationCodeType.values()) {
            operationApproveRequest.setAuthenticationCodeType(authenticationCodeType);
            final OperationUserActionResponse operationUserActionResponse = operationService.attemptApproveOperation(operationApproveRequest);
            assertNotNull(operationUserActionResponse);
    ...
    @Test
    void testAnonymousOperationApprovalNotAllowed() throws GenericServiceException {
        final OperationCreateRequest operationCreateRequest = new OperationCreateRequest();
        ...
        approveRequest.setAuthenticationCodeType(AuthenticationCodeType.POSSESSION_KNOWLEDGE);
    ...
    @Test
    void testAnonymousOperationRejectError() throws GenericServiceException {
        final OperationCreateRequest operationCreateRequest = new OperationCreateRequest();
        operationCreateRequest.setApplications(List.of("PA_Tests"));
        operationCreateRequest.setTemplateName("test-template");
        final OperationDetailResponse operation = operationService.createOperation(operationCreateRequest);
    ...
    @Test
    void testOperationRejectFailedDifferentUserId() throws GenericServiceException {
        final OperationCreateRequest operationCreateRequest = new OperationCreateRequest();
        operationCreateRequest.setApplications(List.of("PA_Tests"));
        operationCreateRequest.setTemplateName("test-template");
        operationCreateRequest.setUserId("test_user_1");
