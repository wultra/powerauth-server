...
INSERT INTO pa_application_version (id, application_id, application_key, application_secret, name, supported)
VALUES (1, 21, 'testKey', 'F9Ameh1Km2/IJ37ijKmccgss', 'default', true);

INSERT INTO pa_recovery_config (id, application_id, activation_recovery_enabled, recovery_postcard_enabled, allow_multiple_recovery_codes, postcard_private_key_base64, postcard_public_key_base64, remote_public_key_base64, postcard_priv_key_encryption)
VALUES (1, 21, true, true, false, 'WM6Q+sc3BqQbcFlG3QXiKmX6bTRgtH0uu+4P3anaN5g=', 'BAQyA52GmYp3pXk5b687ZXuCaFCYVhhPHfryyHyqCbdXCKv4GFHIVq8K5nQAIuQdZrKQXqTXFiwP75j+TNeYTJ0=', 'BABXgGoj4Lizl3GN0rjrtileEEwekFkpX1ERS9yyYjyuM1Iqdti3ihtATBxk5XGvjetPO1YC+qXciUYjIsETtbI=', 0);
