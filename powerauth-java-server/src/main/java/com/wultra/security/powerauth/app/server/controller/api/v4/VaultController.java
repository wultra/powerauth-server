...
import com.wultra.security.powerauth.app.server.service.behavior.tasks.v4.VaultUnlockServiceBehavior;
...
public class VaultController {
    ...
    public ObjectResponse<VaultUnlockResponse> unlockVault(@Valid @RequestBody ObjectRequest<VaultUnlockRequest> request) throws Exception {
        ...
        logger.info("action: unlockVault, state: initiated, activationId: {}, requestTimestamp: {}", req.getActivationId(), req.getTimestamp());
