 ...
 */
@Service("operationServiceBehaviorV4")
@Slf4j
@AllArgsConstructor
public class OperationServiceBehavior {
    ...
    private OperationListRequest convert(final OperationListForUserRequest source) {
        ...
        return new OperationListRequest(source.getUserId(), source.getApplications(), source.getActivationId(), pageable);
    }

    private OperationListRequestWithExternalId convert(final OperationExtIdRequest source) {
        final int pageNumber = fetchPageNumberOrDefault(source.getPageNumber());
        final int pageSize = fetchPageSizeOrDefault(source.getPageSize());
        final Pageable pageable = PageRequest.of(pageNumber, pageSize);
        return new OperationListRequestWithExternalId(source.getExternalId(), source.getApplications(), pageable);
    }
