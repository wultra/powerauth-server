 ...
 */
@Slf4j
public class AuthenticationDataParser {

    /**
     * Parse authentication request data from raw data byte array.
     * @param data Raw authentication request data byte array.
     */
    public static AuthenticationRequestData parseRequestData(final byte[] data) {
        if (data == null) {
        ...
        // Parse standardized request data based on standard PowerAuth authentication data specification:
