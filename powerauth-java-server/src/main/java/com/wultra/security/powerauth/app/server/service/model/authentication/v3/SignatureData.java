 ...
 *
 */
package com.wultra.security.powerauth.app.server.service.model.authentication.v3;
...
public class SignatureData {
     ...
     * @param authCodeConfiguration Format of signature with associated parameters.
     ...
     */
    public SignatureData(byte[] data, String signature, AuthenticationCodeConfiguration authCodeConfiguration, String signatureVersion, List<KeyValue> additionalInfo, Integer forcedSignatureVersion) {
        this.data = data;
