 ...
 */
@Service("tokenServiceBehaviorV4")
@Slf4j
@AllArgsConstructor
public class TokenServiceBehavior {
    ...
    public CreateTokenResponse createToken(CreateTokenRequest request) throws GenericServiceException {
        try {
            ...
            final AuthenticationCodeType powerAuthCodeType = request.getAuthenticationCodeType();
            ...
            final AeadEncryptedResponse encryptedResponse = (AeadEncryptedResponse) createToken(activationId, applicationKey, encryptedRequest, powerAuthCodeType.name(), version);
    ...
    public ValidateTokenResponse validateToken(ValidateTokenRequest request) throws GenericServiceException {
        try {
            ...
            response.setAuthenticationCodeType(authenticationCodeTypeConverter.convertFrom(token.getSignatureTypeCreated()));
            return response;
