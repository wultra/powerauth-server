...
public interface CallbackUrlEventRepository extends CrudRepository<CallbackUrlEventEntity, Long> {
    ...
    @Query("""
            ...
            WHERE c.status = com.wultra.security.powerauth.app.server.database.model.enumeration.CallbackUrlEventStatus.PENDING
    ...
    @Query("""
            ...
            WHERE c.status = com.wultra.security.powerauth.app.server.database.model.enumeration.CallbackUrlEventStatus.COMPLETED
    ...
    @Query("""
            ...
            SET c.status = com.wultra.security.powerauth.app.server.database.model.enumeration.CallbackUrlEventStatus.PENDING,
    ...
    @Query("""
            ...
            SET c.status = com.wultra.security.powerauth.app.server.database.model.enumeration.CallbackUrlEventStatus.PENDING,
                c.timestampNextCall = c.timestampLastCall,
                c.timestampRerunAfter = null
            WHERE c.status = com.wultra.security.powerauth.app.server.database.model.enumeration.CallbackUrlEventStatus.PROCESSING
