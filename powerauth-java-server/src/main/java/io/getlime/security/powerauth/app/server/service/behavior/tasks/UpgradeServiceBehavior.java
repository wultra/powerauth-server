...
public class UpgradeServiceBehavior {
    ...
    @Autowired
    public UpgradeServiceBehavior(RepositoryCatalogue repositoryCatalogue, LocalizationProvider localizationProvider, ServerPrivateKeyVOConverter serverPrivateKeyVOConverter) {
