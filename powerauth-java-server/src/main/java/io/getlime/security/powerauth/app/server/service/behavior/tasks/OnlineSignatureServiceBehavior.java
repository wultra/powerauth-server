...
public class OnlineSignatureServiceBehavior {
     ...
     */
    public VerifySignatureResponse verifySignature(String activationId, SignatureType signatureType, String signature, String signatureVersion, Map<String, Object> additionalInfo, String dataString, String applicationKey, Integer forcedSignatureVersion, KeyConvertor keyConversionUtilities)
     ...
     */
    private VerifySignatureResponse verifySignatureImpl(String activationId, SignatureType signatureType, String signature, String signatureVersion, Map<String, Object> additionalInfo, String dataString, String applicationKey, Integer forcedSignatureVersion, KeyConvertor keyConversionUtilities)
