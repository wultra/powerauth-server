 ...
 * {@link io.getlime.security.powerauth.app.server.database.model.enumeration.RecoveryPukStatus}.
 *
...
public class RecoveryPukStatusConverter {
     ...
     */
    public RecoveryPukStatus convertFrom(io.getlime.security.powerauth.app.server.database.model.enumeration.RecoveryPukStatus recoveryPukStatus) {
     ...
     * @return Converted recovery PUK status.
     */
    public io.getlime.security.powerauth.app.server.database.model.enumeration.RecoveryPukStatus convertTo(RecoveryPukStatus recoveryPukStatus) {
        if (recoveryPukStatus == null) {
            return null;
        }
        switch (recoveryPukStatus) {
