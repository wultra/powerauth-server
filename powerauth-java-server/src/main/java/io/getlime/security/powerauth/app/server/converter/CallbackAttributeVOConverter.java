...
@Converter
@Component
public class CallbackAttributeVOConverter implements AttributeConverter<List<String>, String> {

    private static final Logger logger = LoggerFactory.getLogger(CallbackAttributeVOConverter.class);
