...
/**
 * Model class representing a request to create or update a single configuration item.
 *
...
public class CreateConfigItemRequest {
    ...
    @NotBlank(message = "Application ID must not be empty when creating a configuration item")
    ...
    @NotNull(message = "The configuration scope must be set when creating a configuration item")
    ...
    @NotNull(message = "The configuration value must not be null when creating a configuration item")
    @ToString.Exclude
