 ...
 */
public class OperationTemplateUpdateRequestValidator {

    public static String validate(OperationTemplateUpdateRequest source) {
        if (source == null) {
            return "Operation template update request must not be null";
        }
