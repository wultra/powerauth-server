            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/application/detail/<c:out value="${applicationId}"/>/callback/create/do.submit">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="auth_oAuth2Enabled" class="col-sm-4 control-label">OAuth2 Authentication</label>
                                <div class="col-sm-8" style="margin-top: 6px">
                                    <input type="checkbox" id="auth_oAuth2Enabled" name="auth_oAuth2Enabled" <c:if test="${true eq auth_oAuth2Enabled}">checked</c:if>/>
                                </div>
                            </div>
                            <div class="form-group">
