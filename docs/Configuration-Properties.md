...
| `powerauth.service.scheduled.job.expireTemporaryBlocks`                     | `5000`          | Time delay in milliseconds between two consecutive tasks that expire temporary activation blocks.                                           |
