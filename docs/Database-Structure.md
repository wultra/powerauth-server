...
| server_private_key_encryption  | INT(11)       | NOT NULL, DEFAULT 0                       | Encryption of legacy server private key: 0=NO_ENCRYPTION, 1=AES_HMAC (legacy), 2=AEAD_KMAC (default).                                                                                    |
...
| server_private_keys_encryption | INT(11)       | NOT NULL, DEFAULT 0                       | Encryption for `server_private_keys`: 0=NO_ENCRYPTION, 1=AES_HMAC (legacy), 2=AEAD_KMAC (default).                                                                                       |
...
| shared_secret_encryption       | INT(11)       | NOT NULL, DEFAULT 0                       | Encryption for `shared_secret`: 0=NO_ENCRYPTION, 1=AES_HMAC (legacy), 2=AEAD_KMAC (default).                                                                                             |
...
| version                        | BIGINT(20)    | NOT NULL, 2                               | Cryptography protocol version.                                                                                                                                                           |
...
| master_private_keys_encryption | INT(11)      | NOT NULL, DEFAULT 0            | Encryption: 0=NO_ENCRYPTION, 1=AES_HMAC (legacy), 2=AEAD_KMAC (default). |
...
| private_key_encryption | INT(11)      | -                                                                | Encryption indicator for private key 0=NO_ENCRYPTION, 1=AES_HMAC (legacy), 2=AEAD_KMAC (default).   |
...
| secret_key_encryption  | INT(11)      | -                                                                | Encryption indicator for shared secret 0=NO_ENCRYPTION, 1=AES_HMAC (legacy), 2=AEAD_KMAC (default). |
