...
| `String` | `proximityCheck.seed`       | Optional seed for TOTP, base64 encoded.                                                                                                                                                       |
| `String` | `proximityCheck.stepLength` | Optional length of the TOTP step in seconds.                                                                                                                                                  |
...
| `String`  | `proximityCheck.seed`       | Optional seed for TOTP, base64 encoded.                                                                               |
| `String`  | `proximityCheck.stepLength` | Optional length of the TOTP step in seconds.                                                                          |
| `String`  | `proximityCheck.stepCount`  | Optional count how many backward steps should be validated. Zero means current one only.                              |
