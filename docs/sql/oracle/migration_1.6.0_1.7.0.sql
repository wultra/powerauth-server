...
CREATE TABLE pa_application_config (id INTEGER NOT NULL, application_id INTEGER NOT NULL, key VARCHAR2(255) NOT NULL, values CLOB, CONSTRAINT PK_PA_APPLICATION_CONFIG PRIMARY KEY (id), CONSTRAINT pa_app_config_app_fk FOREIGN KEY (application_id) REFERENCES pa_application(id));
